...
def bicycle_backward(car_speed,x, y, heading, steering,deltat):
    dt = deltat  # the car should reach the goal in 10 second #Not really relevant for the choice of dt?
    lr = 0.32 / 2
...
def bicycle_forward(car_speed, x, y, heading, steering,deltat):
    dt = deltat  # the car should reach the goal in 10 second
    lr = 0.32 / 2
